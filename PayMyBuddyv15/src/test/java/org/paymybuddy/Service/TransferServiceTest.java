...
public class TransferServiceTest {
    ...
    void setUp() {
        ...
        User user1 = new User("Jason", "Burns", "jason@gmail.com", "superPassword", Collections.emptyList());
        Account compte1 = new Account(BigDecimal.valueOf(200L), new Date(), user1);
        compte1.setId(1L);

        User user2 = new User("Jamse", "Blonde", "Jamse@gmail.com", "superPassword", Collections.emptyList());
        ...
        transactionService = new TransferService(transferRepository, accountService, creditCardService, bankService, userService);
    }
